...
!function() {
    var a = $("#box"), b = {lv: $("#room .lv em"),time: $("#room .time"),start: $("#dialog .btn-restart"),back: $("#dialog .btn-back"),share: $("#dialog .btn-share"),pause: $("#room .btn-pause"),resume: $("#dialog .btn-resume"),dialog: $("#dialog"),d_content: $("#dialog .content"),d_pause: $("#dialog .pause"),d_gameover: $("#dialog .gameover")}, c = {init: function(a, b, c) {
            ...
            var shareTitle = "我在1分钟内" + (this.lastLv) + "次从张默身边找到房祖名！可他不跟我走！";
            window.shareData.tTitle=shareTitle;
            btGame.setShare({
                title: shareTitle
            });
            if (this.lastLv > 0) {
                var scoreMsg = "你一共" + (this.lastLv) + "次从张默身边找到房祖名，你的24k氪金眼还没瞎吗？快让你的朋友也来试试吧" ;
                window.shareData.tTitle="我在1分钟内" + (this.lastLv) + "次从张默身边找到房祖名！你也来试试！";
    ...
    var a = $("#box"), b = "span", c = $("#help p"), d = $("#help_color"), e = {lvT: ["龙叔的好兄弟", "龙叔的好朋友", "龙叔的路人粉", "慧眼识震东", "火眼金睛", "洞察一切", "两眼冒光", "24k氪金眼", "已被亮瞎！"],render: function(e, f) {
            ...
            a.find(b).css("background-color", i[1]).data("type", "b").css({"background": "url(img/109451991.png)"+j[1], "background-size": "cover"}), a.find(b).eq(h).css("background-color", j[1]).data("type", "a").css({"background": "url(img/109451988aa.png)"+j[1], "background-size": "cover"});
        },getColor: function(a) {
